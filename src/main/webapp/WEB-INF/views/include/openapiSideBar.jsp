...
<style>
    ...
    .sidebar-menu .nav-link{width:100%;display:flex;align-items:center;justify-content:space-between;padding:12px 16px;font-size:1.05em;color:#000;text-decoration:none;transition:background-color .3s ease,color .3s ease;border-radius:8px;box-sizing:border-box;gap:8px}
    ...
    .submenu{padding:10px 0 10px 25px;border-left:2px solid #eee;margin:0 0 8px 14px}
    .submenu .sub-link{display:flex;align-items:center;gap:8px;padding:8px 0;font-size:.98em;color:#333;text-decoration:none;border-radius:6px}
    .submenu .sub-link:hover{text-decoration:underline}
    .submenu .sub-link.active{color:#0a3d62;font-weight:600}
...
<aside class="sidebar">
    <div class="menu-header-box">OPEN API</div>

    <nav class="sidebar-menu">
        <ul>

            <li class="nav-item">
                <a class="nav-link ${activeMenu eq 'praise' ? 'active' : ''}" href="<c:url value='/openapi/intro' />">
                    <span class="label"><i class="bi bi-star-fill"></i> 서비스 소개</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link ${activeMenu eq 'survey' ? 'active' : ''}" href="<c:url value='/openapi' />">
                    <span class="label"><i class="bi bi-clipboard-check-fill"></i>서비스 목록</span>
                </a>
            </li>
        </ul>
    </nav>
