...
<div id="wrapper">
    ...
    <div id="content">
        <div class="main-container">
            ...
            <div class="table-responsive">
                <table
                    ...
                    <tbody>
                    <c:choose>
                        <c:when test="${not empty applyList and pageContext.request.userPrincipal.principal.usersVO.deptId == 302}">
		...
		<c:if test="${not empty applyList and pageContext.request.userPrincipal.principal.usersVO.deptId == 302}">
