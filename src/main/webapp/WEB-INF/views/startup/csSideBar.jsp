...
<aside class="sidebar">
    <div class="menu-header-box">창업 지원 및 컨설팅</div>

    <nav class="sidebar-menu">
        <ul>
            <li class="nav-item">
                <a class="nav-link ${activeMenu eq 'notice' ? 'active' : ''}" href="<c:url value='/cs/notice' />">
                    <span class="label"><i class="bi bi-megaphone-fill"></i> 공지사항</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <button type="button"
                        id="btn-inquiry"
                        class="nav-link ${(activeMenu eq 'inquiry') ? 'active' : ''}"
                        aria-expanded="${activeMenu eq 'inquiry' ? 'true' : 'false'}"
                        aria-controls="menu-inquiry">
                    <span class="label"><i class="bi bi-question-square-fill"></i> 문의사항</span>
                    <i class="bi bi-chevron-down chevron"></i>
                </button>

                <div id="menu-inquiry" class="collapse ${activeMenu eq 'inquiry' ? 'show' : ''}">
                    <div class="submenu">
                        <a class="sub-link ${(activeMenu eq 'inquiry' and activeSub eq 'qna') ? 'active' : ''}"
                           href="<c:url value='/cs/qna'/>">
                            질의응답(Q&A)
                        </a>
                        <a class="sub-link ${(activeMenu eq 'inquiry' and activeSub eq 'faq') ? 'active' : ''}"
                           href="<c:url value='/cs/faq'/>">
                            자주 묻는 질문(FAQ)
                        </a>
                    </div>
                </div>
            ...
            <li class="nav-item">
                <button type="button"
                    ...
                    <span class="label"><i class="bi bi-building-fill-gear"></i> 조직안내</span>
                    <i class="bi bi-chevron-down chevron"></i>
                </button>
                ...
                <div id="menu-org-guide" class="collapse ${activeMenu eq 'orgGuide' ? 'show' : ''}">
                    <div class="submenu">
                        <a class="sub-link ${activeSub eq 'orgchart' ? 'active' : ''}"
                           href="<c:url value='/cs/org/chart'/>">
                            조직도
                        </a>
                        <a class="sub-link ${activeSub eq 'org' ? 'active' : ''}" href="<c:url value='/cs/org'/>">
                            직원 안내
                        </a>
                    </div>
                </div>
            ...
            <li class="nav-item">
                <a class="nav-link ${activeMenu eq 'praise' ? 'active' : ''}" href="<c:url value='/cs/praise' />">
                    <span class="label"><i class="bi bi-star-fill"></i> 직원 칭찬게시판</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link ${activeMenu eq 'survey' ? 'active' : ''}" href="<c:url value='/cs/survey' />">
                    <span class="label"><i class="bi bi-clipboard-check-fill"></i> 설문 조사</span>
                </a>
            </li>
        </ul>
    </nav>
